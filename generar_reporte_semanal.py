...
from settings import (
    ...
    PROCESSED, ROSTER_SHEET_GID, SESIONES_SHEET_GID, TIPOS_SESION, WELLNESS_SHEET_GID,
    WELLNESS_SHEET_ID,
)
...
from src.loaders.wellness_loader import cargar_desde_sheets as cargar_wellness_desde_sheets
...
def cargar_todo():
    ...
    df_wellness = cargar_wellness_desde_sheets(WELLNESS_SHEET_ID, WELLNESS_SHEET_GID)
